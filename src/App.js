...
function App() {
  ...
  const toggleSubmit = (e) => {
    ...
    if(tramo === '' || tramo === 'Seleccione plazo' ){
    ...
    // setCuotaFija(parseFloat(((Monto * (MV * (1 + MV) ^ n)) / ((1 + MV) ^ n) - 1)).toFixed(2));
    setCuotaFija(parseFloat(cuota).toFixed(2));
  }
          ...
          <Col>
            <Form.Group controlId="formGridState">
              ...
              <Form.Control 
                ...
                value={tramo}
                onChange={handleChange}>
                <option>Seleccione plazo</option>
                {
